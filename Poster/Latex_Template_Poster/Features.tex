...
\begin{itemize}
	\item Physics basded, atomwise partitioned GFN2--xTB quantities are used for the features and were developed in our group and can be categorized into:
	\begin{itemize}
...
\begin{itemize}
	...
	\item The features and targets a computed for each $3 \times 3$ block in a different orientation to achieve a consistent orientation
\end{itemize}
