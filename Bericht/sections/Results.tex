...
\begin{figure}[H]
    ...
    \label{fig:FC_perm}
\end{figure}
Further investigations on the models are necessary, to locate the reason for the break of symmetry.
Worth considering are the rotation proces, the homonuclear and heteronuclear model.
...
Furthermore, a physcial correlation could be presented for the ETR--Gen--Perm model.\\
