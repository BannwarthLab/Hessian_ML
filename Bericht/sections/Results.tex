...
As a first approach, the ETR--Case--Perm model was used for only the subset of the hydrogen molecule.
...
For the approximated range of $1800~\mathrm{cm^{-1}} < \tilde{\nu}_\mathrm{xTB}< 7500~\mathrm{cm^{-1}}$ there are abbreviations from the diagonal and therefore a sufficient prediction.
