...
\begin{figure}[H]
    ...
    \hspace*{0.25cm}
    \subfloat[heteronuclear model]{\includegraphics[width = 0.48\textwidth]{PearsonCorrelationCoeffiecient/PCC_ndiag_perm.eps}}
...
\begin{figure}[H]
    ...
    \hspace*{0.25cm}
    \subfloat[heteronuclear model]{\includegraphics[width = 0.48\textwidth]{PearsonCorrelationCoeffiecient/PCC_element_specific_nondiag_perm.eps}}
    \caption[Element wise computed Pearson Correlation Coefficient shown for the best features of each element (Gen--Perm model).]{
