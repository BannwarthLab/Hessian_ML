...
which leads to the complete energy equation shown in Eq.~\eqref{eq:GFN2:E}.
	...
	\begin{align}
		...
		\end{matrix} \right)
	\end{align}
	For a system of $N$ atoms, the full overlap matrix is shown in Eq.~\eqref{eq:RotTransMatFull}
	\begin{align}
		...
		\right)
	\end{align}
	After that, the rotation and translation matrix is normalized to $\textbf{O}_n$.
	...
	\end{align}
	At last, the hessian needs to be mass weighted. Every element is multiplied by a specifc factor,
	which depends on the mass $m_A$ of the atoms $A$ of the coordinates.
	\begin{align}
