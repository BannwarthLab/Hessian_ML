...
$\textbf{H}_{AB}$ depends on the coordinates of the atoms $A$ and $B$.
Hence, the atom based quantities of $A$ and $B$ are used for the computation of the features.
There is done a differentiation for the case of $A = B$ and $A \neq B$, due to two reasons.
...
The features for all elements in a hessian matrix block $\textbf{H}_{AB}$.
...
and with it the vector/matrix quantities from GFN2--xTB, in dependence of the hessian elements that shall be learned.
