...
The physical quantities, that were investigated are the hessian matrix elements $\dfrac{\partial^2 E}{\partial a \partial b}$,
...
Here, $\lambda$ are the eigenvalues of the mass weighted projected hessian matrix and $m_i$ the mass of each atom.
...
All electronic structure computations were performed with GFN2--xTB\supercite{Bannwarth2019_GFN2xTB}, for this the \textit{xtb} was used.
...
Especially, the packages sklearn, numpy and pandas were used for this project.\supercite{Bannwarth2021_xTB}
